...
{
  protected static function get_user_info(string $username, string $realm, string $filepath = '') : array|false
  {
    if (empty($filepath))
  ...
  //Internal methods.
  private function digest(string $realm = 'Restricted Area') : string|false
  {
    $rv = false;
  ...
  ------------------------------------------------------------------------------*/
  public function certify(mixed $data = null, $params = 'Restricted Area') : array|bool
  {
    $rv = false;
